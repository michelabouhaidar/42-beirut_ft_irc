...
/*   Updated: 2026/01/02 01:54:36 by mabou-ha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Server::disconnectClient(int fd, const std::string &reason)
{
    ...
    if (c)
    {
        // Broadcast PART-like info to channels (optional but helps clients)
    ...
    // Best-effort ERROR before close (do not queue; socket is about to close)
